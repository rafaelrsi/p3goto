...
/** RRS: 06/23/15
    This package implements the gotoActionExample from ARIA library in ROS.
    I tested it on MobileSim and it worked very well. It can be used as starting
    point to a project using Pionner Robots withou using RosAria or p2os ROS libraries.
*/
int main(int argc, char **argv)
{

// Initialize the ROS system.
  ros::init(argc, argv, "hello_ros"); // RRS: I am assuming no arguments, it is needed to deal with in future versions

  // Establish this program as a ROS node.
  ros::NodeHandle nh;

  Aria::init();
  ArArgumentParser parser(&argc, argv); // RRS: I am assuming no arguments, it is needed to deal with in future versions
